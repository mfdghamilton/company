...
-- Dumping structure for table companydatabase.department
...
-- Dumping data for table companydatabase.department: ~12 rows (approximately)
...
-- Dumping structure for table companydatabase.location
...
-- Dumping data for table companydatabase.location: ~5 rows (approximately)
...
-- Dumping structure for table companydatabase.personnel
...
-- Dumping data for table companydatabase.personnel: ~100 rows (approximately)
